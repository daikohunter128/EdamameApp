...
(function() {
  var toggle_home_address_fields;

  $(document).on('turbolinks:load', function() {
    $('form.edit_customer').on('click', '#enable-password-field', function() {
      $('#enable-password-field').hide();
      $('#disable-password-field').show();
      $('#customer_password').removeAttr('disabled');
      return $('label[for=customer_password]').addClass('required');
    });
    return $('form.edit_customer').on('click', '#disable-password-field', function() {
      $('#disable-password-field').hide();
      $('#enable-password-field').show();
      $('#customer_password').attr('disabled', 'disabled');
      return $('label[for=customer_password]').removeClass('required');
    });
  });
...
(function() {
  ...
  $(document).on('turbolinks:load', function() {
    ...
    return $('input#form_inputs_home_address').on('click', function() {
